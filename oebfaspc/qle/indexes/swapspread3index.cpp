...
namespace QuantExt {
    ...
    SwapSpread3Index::SwapSpread3Index(
        ...
        swapIndex1_(swapIndex1), swapIndex2_(swapIndex2), swapIndex3_(swapIndex3), 
        gearing1_(gearing1), gearing2_(gearing2), gearing3_(gearing3), 
        spread_(spread), strike_(strike), cap_(cap), floor_(floor),
        elseconstant_(elseconstant), structchoice_(structchoice) {
        ...
        name << std::setprecision(4) << std::fixed << "SwapSpread3:" << swapIndex1_->name() << "("
             << gearing1 << ") + " << swapIndex2_->name() << "(" << gearing2 << ")" << swapIndex3_->name() << "(" << gearing3 << "),spread:" << spread << ",strike:" << strike << ",cap:" << cap << ",floor:" << floor << ",elseconstant:" << elseconstant << ",structtype:" << structchoice;
        name_ = name.str();
