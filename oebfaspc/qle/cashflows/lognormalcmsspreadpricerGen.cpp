...
/*! \file lognormalcmsspreadpricerGen.cpp
*/

#include <../oebfaspc/qle/cashflows/lognormalcmsspreadpricerGen.hpp>
...
namespace QuantExt {
    ...
    LognormalCmsSpreadPricerGen::initialize(const FloatingRateCoupon &coupon) {
        ...
        //QL_REQUIRE(gearing1_ > 0.0 && gearing2_ < 0.0,"gearing1 (" << gearing1_ << ") should be positive while gearing2 ("<< gearing2_ << ") should be negative");
        ...
        if (volType_ == ShiftedLognormal) {
            ...
            res +=
                ...
                integrator_->operator()(std::bind1st(
                    std::mem_fun(&LognormalCmsSpreadPricerGen::integrand), this));
        } else {
            // normal volatility
